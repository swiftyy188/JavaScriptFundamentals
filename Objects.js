...
function recipeCard(recipe){
	...
	console.log("serves: " +  recipe.serve);
...
function movieDatabase(movie){
	console.log(movie.title + " lasts for " + movie.duration + "minutes.  " + movie.stars + "star");
}
